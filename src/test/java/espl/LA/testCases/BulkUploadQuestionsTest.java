...
import espl.LA.pageObjects.BulkUploadQuestionsPage;
...
public class BulkUploadQuestionsTest extends BaseClass {
	
	
	@Test
	
	public void BulkuploadQuestions() throws IOException, InterruptedException, AWTException
	{
...
//------------------------------Configure the assessment Activity------------------------------------------------------
		...
		act1.ClickingOnGearWheel(); //Gear wheel icon
...
//------------------------------Setup New Learning Activity------------------------------------------------------
		 ...
		 //------------------------------Setup Activity Questions------------------------------------------------------

		   logger=report.createTest("Upload Questions");
		   
		   BulkUploadQuestionsPage uploadQ =PageFactory.initElements(driver, BulkUploadQuestionsPage.class);
		 
		   Reporter.log("clicking on upload questions button",true);

		   Thread.sleep(3000);
		   uploadQ.uploadquestions();
		   
		   Reporter.log("clicking on upload questions button done",true);
