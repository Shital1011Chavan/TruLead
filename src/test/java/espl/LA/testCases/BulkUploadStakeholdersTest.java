...
import espl.LA.pageObjects.BulkUpload360degreeStakeholdersPage;
...
public class BulkUploadStakeholdersTest extends BaseClass {
	
	@Test()
	public void BulkuploadstakeTest() throws IOException, InterruptedException, AWTException 
	{
...
//-----------------------------Setup 360 Degree Activity------------------------------------------------------
	...
	//-----------------------------Bulkupload stakeholders----------------------------------------	 
		
		 BulkUpload360degreeStakeholdersPage stake=PageFactory.initElements(driver, BulkUpload360degreeStakeholdersPage.class);

		 Reporter.log("Selecting feedback Roles",true);
		 stake.SelectfeedbackRoles();
		 
		 Reporter.log("Bulkupload stakeholders",true);
		 stake.uploadStakeholders();
